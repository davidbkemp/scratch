...
(function () {
    ...
    function manageAnimation() {
        var animation,
            svgElement = jQuery("#fullInterferenceExampleSvg"),
            qstateElement = jQuery("#fullInterferenceQState"),
            hadamardButton = jQuery("#fullInterferenceExampleButton");
        ...
        hadamardButton.click(onClickOperationButton);
    }
